...
<div class="header">
    ...
    <div class="header3">
        <%String name = (String)session.getAttribute("userName");out.println("<h2>"+name + " 老师欢迎你！"+"</h2>");
...
<div class="nav nav1">
    <a href="teacher-index.jsp">系统首页</a>
    <a href="${pageContext.request.contextPath}/IdServlet">个人中心</a>
    <a href="${pageContext.request.contextPath}/TeacherSIdServlet"> 学生信息查看</a>
    <a href="${pageContext.request.contextPath}/TeacherScoreServlet"> 学生成绩查看</a>
</div>
